...
?>
    <p>
    <strong>Id</strong> : <?php echo $donnees['idAdh']; ?><br />
    Le nom : <?php echo $donnees['nom']; ?>
    Le perenom<?php echo $donnees['prenom']; ?>  <?php echo $donnees['dateNaissance']; ?>  <?php echo $donnees['nom']; ?>
   </p>	
